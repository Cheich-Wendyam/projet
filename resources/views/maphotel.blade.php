...
@section('content')
<br><br><br>
<div id="map" data-spaces='@json($spaces)' data-restos='@json($restos)' data-sites='@json($sites)' data-event='@json($event)' data-hotels='@json($hotels)' data-hotel='@json($hotel)'></div>
</div>
